...
export function RankingSaneamento({ ranking }: Props) {
  ...
  return (
    <section className="mx-auto min-w-0 max-w-7xl px-4 pb-8">
      <div className="w-full max-w-full overflow-hidden rounded-md border border-ms-line bg-white shadow-sm">
        <div className="grid min-w-0 gap-0 xl:grid-cols-[minmax(0,1fr)_22rem]">
          <div className="min-w-0 p-5 md:p-6">
            ...
            <div className="mt-6 min-w-0 max-w-full overflow-x-auto">
              <table className="w-full min-w-[44rem] text-sm lg:min-w-0">
                <thead>
                ...
                <tbody className="divide-y divide-ms-line">
                  {ranking.map((item) => (
                    <tr key={item.codigo_ibge} className="align-top">
                      ...
                      <td className="min-w-44 py-4 pr-4">
                        <Link
